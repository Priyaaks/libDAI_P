...
#  cp /Applications/Utilities/libDAI-0.3.1/$1_factor_graphs/$1_{0..9}.fg /Applications/Utilities/libDAI-0.3.1/${samples[$p]}/${tabfile[$j]}/$q/${pm[$k]}/0
 cp /Applications/Utilities/libDAI-0.3.1/Recodata/Movie4Node2_factor_graphs/Movie4NodeBN2_{10..20}.fg /Applications/Utilities/libDAI-0.3.1/Recodata/Movie4NodeBN2_EM1/$q/${pm[$k]}/0
...
# FOR RECO DATA
			 /Applications/Utilities/libDAI-0.3.1/examples/example_gaem_deterministic /Applications/Utilities/libDAI-0.3.1/Recodata/Movie4NodeBN1/u1base200.tab /Applications/Utilities/libDAI-0.3.1/Recodata/Movie4NodeBN2_EM1/$q/${pm[$k]}/${pm[$k]}.log ${pm[k]} ${pc[3]} /Applications/Utilities/libDAI-0.3.1/Recodata/Movie4NodeBN2_EM1/$q/${pm[$k]}/ $q.log Movie4NodeBN2
# /Applications/Utilities/libDAI-0.3.1/examples/example_gaem_deterministic /Applications/Utilities/libDAI-0.3.1/$1/${samples[$p]}/${tabfile[$j]}.tab /Applications/Utilities/libDAI-0.3.1/${samples[$p]}/${tabfile[$j]}/$q/${pm[$k]}/${pm[$k]}.log ${pm[k]} ${pc[3]} /Applications/Utilities/libDAI-0.3.1/${samples[$p]}/${tabfile[$j]}/$q/${pm[$k]}/ $q.log $1
