...
declare pm=(0.05555 0.1 0.3 0.5)
	 ...
	 #mkdir /home/cmusv/priya/libDAI-0.3.1/${samples[$p]}
		...
		do
		 #mkdir -p /home/cmusv/priya/libDAI-0.3.1/${samples[$p]}/${tabfile[$j]}/$q
			...
			do
			   #mkdir -p /home/cmusv/priya/libDAI-0.3.1/${samples[$p]}/${tabfile[$j]}/$q/${pm[$k]}/0
			   #mkdir /home/cmusv/priya/libDAI-0.3.1/${samples[$p]}/${tabfile[$j]}/$q/${pm[$k]}/learned
			   #l=${fgfile[$k]} 
			   #u=${fgfile[$k+1]}
			   #cp /home/cmusv/priya/libDAI-0.3.1/carstarts_factor_graphs/carstarts_*.fg /home/cmusv/priya/libDAI-0.3.1/${samples[$p]}/${tabfile[$j]}/$q/${pm[$k]}/0
			   #cp /home/cmusv/priya/libDAI-0.3.1/carstarts_fg/carstarts_{12000..12499}.fg /home/cmusv/priya/libDAI-0.3.1/${samples[$p]}/${tabfile[$j]}/$q/${pm[$k]}/0
			   ...
			   #/home/cmusv/priya/libDAI-0.3.1/examples/example_Newasia_gaem /home/cmusv/priya/libDAI-0.3.1/$1/${samples[$p]}/${tabfile[$j]}.tab /home/cmusv/priya/libDAI-0.3.1/${samples[$p]}/${tabfile[$j]}/$q/${pm[$k]}/${pm[$k]}.log ${pm[0]} ${pc[0]} /home/cmusv/priya/libDAI-0.3.1/${samples[$p]}/${tabfile[$j]}/$q/${pm[$k]}/
...
##>> /home/cmusv/priya/libDAI-0.3.1/${samples[$p]}/${tabfile[$j]}/$q/${pm[$k]}/out.log
			done
		done
	done
done
