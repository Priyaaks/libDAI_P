...
int main() {
    ...
    SprinklerNetwork.ReadFromFile( "alarm_0.fg" );
    cout << "Sprinkler network read from 2NodeBN.fg" << endl;
	...
	{
	    /*if(i == 1) //hidding the first state
		{
		  outfile << (i == 0 ? "" : "\t"); 
		  continue;
		}*/
