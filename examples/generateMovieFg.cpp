...
string alarmlearnedfgloc = "/Applications/Utilities/libDAI-0.3.1/Recodata/400/Movie4Node1_factor_graphs/";
int main(int argc, char *argv[]) {
string line1;
cout<<alarmlearnedfgloc<<endl;
int t=11;
...
for( size_t n = 1; n < t; n++ )
{
	...
	num2 << n; 
	number2 = num2.str();
	string parent2 = alarmlearnedfgloc +"Movie4NodeBN1_"+number2+".fg";	
		 ...
		 for(int k=0; k<arr_set; k++)
		  {
			...
			for(int m=0; m<arr_size; m++)
			{
			    ...
			    for (int ii=0; ii<no_arr_arrset; ii++) 
			    {
				double* arr = *it;
				double value=vec[ii];
			 	value /= total;
